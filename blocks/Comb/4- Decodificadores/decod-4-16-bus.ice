{
  "version": "1.2",
  "package": {
    "name": "Decodificador-4-16-bus",
    "version": "1.0",
    "description": "Decodificador de 4 a 16, con salida en bus",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "183d7a43-c779-498a-85ce-5fb15b2bfe97",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[15:0]",
        ...
        {
          "id": "465e5e58-ee68-48e0-a38e-2261f5d71e4b",
          "type": "basic.input",
          "data": {
            "name": "y",
            "range": "[3:0]",
      ...
      "wires": [
        {
          "source": {
            "block": "465e5e58-ee68-48e0-a38e-2261f5d71e4b",
            "port": "out"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "183d7a43-c779-498a-85ce-5fb15b2bfe97",
            "port": "in"
          },
          "size": 16
        }
