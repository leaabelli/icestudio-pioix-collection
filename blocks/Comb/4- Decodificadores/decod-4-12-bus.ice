{
  "version": "1.2",
  "package": {
    "name": "Decodificador-4-12-bus",
    "version": "1.0",
    "description": "Decodificador de 4 a 12, con salida en bus",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "f3e35d5a-80a4-447e-8df7-1cf9e682ddd4",
          "type": "basic.input",
          "data": {
            "name": "y",
            "range": "[3:0]",
        ...
        {
          "id": "b9733e4b-c92d-4516-aee5-6cbe9c5e3a4b",
          "type": "basic.output",
          "data": {
            "name": "z",
            "range": "[11:0]",
        ...
        {
          "id": "1eae12e2-701d-4e9e-9821-55e44c887ed0",
          "type": "basic.code",
          "data": {
            "code": "assign i = 1 << y;\n                      ",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "f3e35d5a-80a4-447e-8df7-1cf9e682ddd4",
            "port": "out"
          },
          "target": {
            "block": "1eae12e2-701d-4e9e-9821-55e44c887ed0",
            "port": "y"
          },
          "vertices": [],
          "size": 4
        },
        {
          ...
          "target": {
            "block": "b9733e4b-c92d-4516-aee5-6cbe9c5e3a4b",
            "port": "in"
          },
          "vertices": [],
          "size": 12
